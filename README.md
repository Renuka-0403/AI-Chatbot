...
Chatbot Workflow
The user enters a question in the Lumora AI chat interface.
The user query is sent to the Hugging Face Inference API.
The hosted AI language model processes the query.
The model generates an AI-powered response.
